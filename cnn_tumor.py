...
image_dir='deep-learning\\CNN\\tumordata'
...
history=model.fit(x_train,y_train,epochs=5,batch_size =128,validation_split=0.1)  #complete statistics of training will be stored here   
...
make_prediction(cv2.imread('deep-learning\\CNN\\tumordata\\yes\\y0.jpg'),model)
print("--------------------------------------\n")
make_prediction(cv2.imread('deep-learning\\CNN\\tumordata\\no\\no0.jpg'),model)
print("--------------------------------------\n")
